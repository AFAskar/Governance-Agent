            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            className="bg-ndmo-blue-medium hover:bg-ndmo-blue-dark text-primary px-6 py-3 rounded-lg font-semibold transition-colors flex items-center gap-2"
                        >
                ...
                {/* Overall Score Card */}
                <div className="bg-gradient-to-br from-ndmo-blue-medium to-ndmo-blue-dark rounded-2xl p-8 mb-8 text-primary shadow-lg">
                    <div className="flex items-center justify-between">
                        <div>
