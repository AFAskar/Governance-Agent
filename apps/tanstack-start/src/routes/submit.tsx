...
function DomainUploadSection({
  ...
  return (
    <div className="border-ndmo-gray-light border-b pb-6 last:border-b-0">
      <div className="flex items-start gap-4">
        {/* Domain Number */}
        <div className="bg-ndmo-blue-medium text-primary flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full text-sm font-bold">
          {domain.order}
        </div>

        {/* Domain Content */}
        <div className="flex-1">
          <h3 className="text-ndmo-blue-dark mb-3 font-semibold">
            {domain.name}
          </h3>
          ...
          <div className="space-y-3">
            <label className="block">
              <input
                ...
                className="text-ndmo-gray-medium file:bg-ndmo-blue-pale file:text-ndmo-blue-dark hover:file:bg-ndmo-blue-light hover:file:text-primary block w-full text-sm file:mr-4 file:cursor-pointer file:rounded-lg file:border-0 file:px-4 file:py-2 file:text-sm file:font-semibold file:transition-colors"
              />
            </label>
            ...
            {files.length > 0 && (
              <div className="space-y-2">
                {files.map((file, index) => (
                  <div
                    key={index}
                    className="bg-ndmo-gray-light/50 flex items-center justify-between rounded-lg px-3 py-2"
                  >
                    <div className="flex min-w-0 flex-1 items-center gap-2">
                      <svg
                        className="text-ndmo-blue-medium h-4 w-4 flex-shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      <span className="text-ndmo-gray-dark truncate text-sm">
                        {file.name}
                      </span>
                      <span className="text-ndmo-gray-medium flex-shrink-0 text-xs">
                    ...
                    <button
                      ...
                      className="text-ndmo-red ml-2 flex-shrink-0 hover:text-red-700"
                    >
                      <svg
                        className="h-4 w-4"
                        fill="none"
                ...
                {files.length >= 20 && (
                  <p className="text-ndmo-yellow text-xs">
